  ...
  return (
    <div className="rounded-lg border border-slate-200 bg-slate-50 p-4 text-sm">
      ...
      <dl className="mt-2 grid gap-1 sm:grid-cols-2">
        <dt className="text-slate-600">Base payroll (est.)</dt>
        <dd className="font-medium">{formatCurrency(basePayroll)}</dd>
        <dt className="text-slate-600">Benefits cost (est.)</dt>
        <dd className="font-medium">{formatCurrency(benefitsCost)}</dd>
        <dt className="text-slate-600">Bonus pool (est.)</dt>
        ...
        {compRatio != null && (
          <>
            <dt className="text-slate-600">Compensation ratio</dt>
